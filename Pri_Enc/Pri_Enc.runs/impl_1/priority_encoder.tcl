...
set rc [catch {
  ...
  add_files -quiet D:/Xilinx/Pri_Enc/Pri_Enc.runs/synth_1/priority_encoder.dcp
...
set rc [catch {
  ...
  catch { report_drc -file priority_encoder_drc_routed.rpt -pb priority_encoder_drc_routed.pb -rpx priority_encoder_drc_routed.rpx }
  catch { report_methodology -file priority_encoder_methodology_drc_routed.rpt -rpx priority_encoder_methodology_drc_routed.rpx }
  ...
  catch { report_power -file priority_encoder_power_routed.rpt -pb priority_encoder_power_summary_routed.pb -rpx priority_encoder_power_routed.rpx }
...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile priority_encoder.bit 
